...
def generate_bland_altman_plotly():
    ...
    def plot_ba_plotly(calc, ref, lbls, title, filename, x_label):  # <-- Neuer Parameter hier
        ...
        fig.add_hline(y=bias + 1.96 * sd, line_dash="dash", line_color="green",
                      annotation_text=f"+1.96 SD: {bias + 1.96 * sd:.2f}")
        fig.add_hline(y=bias - 1.96 * sd, line_dash="dash", line_color="green",
                      annotation_text=f"-1.96 SD: {bias - 1.96 * sd:.2f}")
    ...
    plot_ba_plotly(calc_sys_list, ref_sys_list, labels, "Bland-Altman: Systole (Kombinierte Optimierung)", "bland_altman_sys", "Mittelwert (Algorithmus & Kombinierte Referenz) [mmHg]")
    plot_ba_plotly(calc_dia_list, ref_dia_list, labels, "Bland-Altman: Diastole (Kombinierte Optimierung)", "bland_altman_dia", "Mittelwert (Algorithmus & Kombinierte Referenz) [mmHg]")
    ...
    plot_ba_plotly(calc_sys_b, ref_sys_b, labels_b, "Bland-Altman: Systole (Beurer Optimierung)", "bland_altman_beurer_sys", "Mittelwert (Algorithmus & Beurer) [mmHg]")
    plot_ba_plotly(calc_dia_b, ref_dia_b, labels_b, "Bland-Altman: Diastole (Beurer Optimierung)", "bland_altman_beurer_dia", "Mittelwert (Algorithmus & Beurer) [mmHg]")
    ...
    plot_ba_plotly(calc_sys_n, ref_sys_n, labels_n, "Bland-Altman: Systole (NAIS Optimierung)", "bland_altman_nais_sys", "Mittelwert (Algorithmus & NAIS) [mmHg]")
    plot_ba_plotly(calc_dia_n, ref_dia_n, labels_n, "Bland-Altman: Diastole (NAIS Optimierung)", "bland_altman_nais_dia", "Mittelwert (Algorithmus & NAIS) [mmHg]")
